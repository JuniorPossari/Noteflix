...
var DiretorAPI = function() {
    ...
    var urlListar = "/Noteflix/Diretor/Listar/";
    ...
    var table = function () {
        ...
        var options = Object.assign({}, _DefaultKTDatatablesOptions);

        options.data.source.read.url = urlListar;
        ...
        options.columns = [{
            ...
            template: function (row) {
                ...
                return '\
                    ...
                    <a href="javascript:;" class="btn btn-sm btn-clean btn-icon" data-id="'+ idElemento + '" data-toggle="tooltip" title="Visualizar">\
        ...
        //inicia o datatable passando as options definidas como parametro
        dataTable = $('#kt_datatable').KTDatatable(options);

        $(dataTable).on('datatable-on-init', function () {
            //Fazer aqui os código de eventos dos click de menus extras
            //exemplo
            $('.classElement').on('click', function () {
                //your code here
            })
