                        ...
                        foreach ($diretores as $diretor) {
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:;" class="btn btn-lg btn-sm btn-clean btn-icon mr-2 edit" data-id="<?php echo $idCriador; ?>" data-toggle="tooltip" title="Alterar">
                                            <i class="flaticon2-edit icon-md"></i>
                                            </a>
                                            <a href="javascript:;" class="btn btn-lg btn-sm btn-clean btn-icon mr-2 delete" data-id="<?php echo $idCriador; ?>" data-toggle="tooltip" title="Excluir">
                                                <i class="flaticon2-trash icon-md"></i>
                                            </a>
                                            <a href="javascript:;" class="btn btn-lg btn-sm btn-clean btn-icon view" data-id="<?php echo $idCriador; ?>" data-toggle="tooltip" title="Visualizar">
