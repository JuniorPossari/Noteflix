...
<div class="container-fluid h-100" style="width: 80% !important;">
    ...
    <div class="card card-custom h-100" style="background-color: #f8f7ff; border-radius: 20px; border: 2px solid;">
        ...
        <div class="card-body">
            <form id="Form">
                <input type="hidden" name="CriadorId" class="d-none" id="CriadorId" value="<?php echo $Id; ?>">
        ...
        <div class="card-footer">
            <a href="/Noteflix/Criador/Index" class="btn btn-secondary font-weight-bold mr-2">Voltar</a>
