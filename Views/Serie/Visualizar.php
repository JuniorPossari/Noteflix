        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex flex-column">                
                ...
                <div class="d-flex align-items-center font-weight-bold my-2">
                    ...
                    <!--begin::Item-->
                    <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                    <a href="/Serie/Visualizar" class="text-white text-hover-white opacity-75 hover-opacity-100">Visualizar</a>
                    <!--end::Item-->                    
                </div>
                <!--end::Breadcrumb-->
            </div>
...
<div class="container-fluid fundo-padrao">
    ...
    <div class="card card-custom card-padrao">
        ...
        <div class="card-footer">
            <a href="/Serie/Index" class="btn btn-lg btn-secondary font-weight-bold mr-2">Voltar</a>
        </div>
        <!--end:Footer-->
    </div>
    <!--end::Card-->        
