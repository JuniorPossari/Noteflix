        ...
        <div class="card-body">
            <form id="Form">
                ...
                <div class="form-group"> 
                    ...
                    <div class="input-group date">
                        <input type="text" class="form-control" name="SerieDataTermino" id="SerieDataTermino" placeholder="Defina a data" autocomplete="off" value="<?php echo implode("/",array_reverse(explode("-", $DataTermino))); ?>" />
                        <div class="input-group-append">
                            <span class="input-group-text">
                                <i class="la la-calendar-check-o"></i>
                            </span>
