    ...
    <div class="card card-custom card-padrao">
        ...
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-label font-weight-bolder text-dark">Atores</h3>
            </div>
            <div class="card-toolbar">
                <a href="/Noteflix/Ator/Cadastrar" class="btn btn-lg btn-light-dark font-weight-bold"><i class="flaticon2-add-square icon-md mb-1"></i>Cadastrar</a>
            </div>
        </div>
        <!--end::Header-->
        <!--begin::Body-->                    
                        ...
                        foreach ($atores as $ator) {
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:;" class="btn btn-lg btn-sm btn-clean btn-icon mr-2 edit" data-id="<?php echo $idAtor; ?>" data-toggle="tooltip" title="Alterar">
                                            <i class="flaticon2-edit icon-md"></i>
                                            </a>
                                            <a href="javascript:;" class="btn btn-lg btn-sm btn-clean btn-icon mr-2 delete" data-id="<?php echo $idAtor; ?>" data-toggle="tooltip" title="Excluir">
                                                <i class="flaticon2-trash icon-md"></i>
                                            </a>
                                            <a href="javascript:;" class="btn btn-lg btn-sm btn-clean btn-icon view" data-id="<?php echo $idAtor; ?>" data-toggle="tooltip" title="Visualizar">
