                        ...
                        <td>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="ml-2 w-100">
                                    <div class="mb-1 d-flex justify-content-between"><a href="javascript:;" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><?php echo $nome; ?></a><label><?php echo $datetime->format("d/m/y H:m:s"); ?></label></div>                        
                                    <div class="mb-1"><?php echo $filmeService->ObterNotaUsuario($idFilme, $idUsuario, "icon-md", true); ?></div>
                                    <div class="mb-1">
                                    <?php echo str_replace(">", "&gt;", str_replace("<","&lt;", $observacao)); ?>
                                    </div>
                                </div>
                            </div>   
