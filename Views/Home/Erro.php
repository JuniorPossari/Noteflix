...
<html lang="pt-br">
	...
	<head><base href="../../../">
		...
		<link href="/Metronic/demo2/dist/assets/css/pages/error/error-3.css" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
		...
		<div class="d-flex flex-column flex-root">
			<!--begin::Error-->
			<div class="error error-3 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url(/Metronic/demo2/dist/assets/media/error/bg3.jpg);">
				<!--begin::Content-->
